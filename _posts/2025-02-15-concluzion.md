...
{% include image-align.html file="СадыНаРеке.jpg" caption="Рекламный щит у въезда на территорию" align="center" width="60%" %}<br>
...
Использованию земель в соответствии с разрешенным использованием «Для дачного строительства» препятствуют:
